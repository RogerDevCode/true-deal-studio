...
1. **¿Cuánto invierto?** Dos hitos: $49.999 CLP para iniciar y $50.000 CLP al aprobar la versión lista para publicar, con adicionales separados y voluntarios.
...
El plazo se muestra siempre junto a su condición: comienza cuando STAX recibe el formulario completo, textos base, fotos y los datos para comprar el nombre del sitio y su publicación.
...
- Guía para que el cliente compre a su nombre el nombre de su sitio y el servicio donde quedará publicada la página.
- Configuración y publicación de la página una vez que el cliente contrata esos servicios.
- Una ronda consolidada de cambios de texto e imágenes antes de publicar.
- Quince días posteriores a la publicación para correcciones menores de textos, fotos, horarios, enlaces o funcionamiento.
...
- Compra del nombre del sitio, servicio de publicación, comisiones de terceros o pagos de servicios externos.
...
- **Todo queda a tu nombre.** El nombre del sitio y su publicación se pagan directamente al proveedor; STAX guía la compra y deja todo funcionando.
...
- **Quince días para ajustes menores.** Después de publicar se corrigen datos o funcionamiento; no incluye nuevas secciones, rediseño ni funciones nuevas.
...
2. Su tarjeta incorpora un bloque breve "Para empezar necesitas" con formulario, textos, fotos y datos para comprar el nombre del sitio y su publicación.
...
- Etiqueta de precio: **$49.999 CLP para iniciar + $50.000 CLP al aprobar la versión lista.**
- Apoyo: **Alcance cerrado, una ronda de cambios, 15 días de ajustes menores y todo a tu nombre.**
- Requisito: **El plazo comienza cuando recibimos tu información completa.**

Se evita prometer ventas, consultas, conversiones, publicación gratuita permanente o ajustes ilimitados.
