window.artesaniasApp = function artesaniasApp() {
  ...
  return {
    ...
    geoError: '',
    products: [
      { id: 1, name: 'Fuente de Greda Pomaire', price: 18500, category: 'greda', image: 'greda.webp', desc: 'Moldeado a mano y cocido en horno de leña. Ideal para preparaciones tradicionales chilenas.', origin: 'Melipilla' },
      { id: 2, name: 'Manta de Lana de Oveja', price: 45000, category: 'lana', image: 'wool.webp', desc: 'Tejido rústico hilado a mano en telar de Chiloé. 100% lana natural ultra abrigadora.', origin: 'Chiloé' },
      { id: 3, name: 'Tabla de Madera Nativa (Lenga)', price: 28000, category: 'madera', image: 'wood.webp', desc: 'Madera noble de lenga con corte vivo lateral, curada con cera orgánica de abeja.', origin: 'Villarrica' },
      { id: 4, name: 'Paila Rústica de Greda', price: 12500, category: 'greda', image: 'greda.webp', desc: 'Paila tradicional con asas de greda refractaria apta para fuego directo.', origin: 'Melipilla' },
      { id: 5, name: 'Choapino Grueso de Telar', price: 22000, category: 'lana', image: 'wool.webp', desc: 'Alfombra pequeña de entrada en lana virgen natural gruesa de alta resistencia.', origin: 'Chiloé' },
      { id: 6, name: 'Mortero de Madera de Roble', price: 19500, category: 'madera', image: 'wood.webp', desc: 'Tallado a mano en una sola pieza maciza de roble patagónico. Incluye mazo.', origin: 'Villarrica' },
    ],
    cart: [],
    formName: '',
    formPhone: '',
